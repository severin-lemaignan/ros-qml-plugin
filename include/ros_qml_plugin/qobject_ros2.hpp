...
#ifndef ROS_QML_PLUGIN__QOBJECT_ROS2_HPP_
#define ROS_QML_PLUGIN__QOBJECT_ROS2_HPP_

#include <QObject>

/*!
 * Base class for QObjects that require ROS functionality.
 * Provides virtual methods that are called once ROS was initialized and once it
 * was shutdown to enable initialization and clean-up of of functionality that
 * requires ROS.
 */
...
protected:
   ...
   *
   * Override to perform clean-up of functionality that depends on ROS, e.g., if
   * the destruction order does not guarantee destruction before required ROS
...
#endif  // ROS_QML_PLUGIN__QOBJECT_ROS2_HPP_
